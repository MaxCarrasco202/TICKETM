<?php if(isset($_SESSION['nombre']) && isset($_SESSION['tipo'])){
        ...
        if(isset($_POST['fecha_ticket']) && isset($_POST['name_ticket']) && isset($_POST['email_ticket'])){
          ...
          $cabecera="From: COLEGIO<linuxstore@hifenix.com>";
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-8">
                      <form class="form-horizontal" role="form" action="" method="POST">
                          ...
                          <div class="col-sm-10">
                              <div class='input-group'>
                                <select class="form-control" name="departamento_ticket">
                                  <option value="Asuntos Estudiantiles">Oficina de Asuntos Estudiantiles:</option>
                                  <option value="Servicios Generales"> Departamento de Servicios Generales</option>
                                  <option value="Mantenimiento">Mantenimiento y Equipamiento</option>
                                </select>
                        ...
                        <div class="form-group">
                          <label  class="col-sm-2 control-label">problema del servivio</label>
                          <div class="col-sm-10">
