<div class="container">
  <div class="row well">
    ...
    <div class="col-sm-9 lead">
      ...
      <p>si usted tiene problemas  enviar un nuevo ticket, nosotros lo respondemos y solucionaremos su problema.<br>Si ya nos ha enviado un ticket puede consultar el estado de este mediante su <strong>Ticket ID</strong>.</p>
    </div>
  </div><!--fin row 1-->
